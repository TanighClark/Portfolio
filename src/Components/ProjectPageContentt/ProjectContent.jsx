...
const ProjectContent = () => {
  return (
    ...
    <div className='projectContents'>
      ...
      <video className='video' src={video}  width='600px' height='100%'/>
      
      <p>The mock Netflix website is intricately designed mock Netflix account, demonstrating my prowess in front-end development and UI/UX design.
